    ...
    return (
        <div className='flex justify-between container mx-auto gap-2 my-2'>
            ...
            <ul className='flex gap-5 justify-between items-center'>
                ...
                <li className='text-gray-700'><Navlink href="/about-us">About</Navlink></li>
                <li className='text-gray-700'><Navlink href="/career" className="text-purple-800">Career</Navlink></li>
            </ul>
